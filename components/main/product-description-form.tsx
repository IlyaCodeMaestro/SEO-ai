...
interface ProductDescriptionFormProps {
  onClose: () => void
  onSubmit: (data: { sku: string; competitorSku: string; cardId?: number }) => void
}
      ...
      {isMobile && (
        <div className="flex flex-col">
          ...
          <div className="text-center mb-8 mt-6">
            <h2 className="text-black text-xl font-medium">Описание карточки товара</h2>
          </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit(onFormSubmit)}>
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500 text-center">
                  Если у вас пока нет карточки, введите SKU
                  <br />
                  похожего товара
                </p>
                <div>
                  <Input
                    ...
                    placeholder="SKU (описываемый товар)"
                    autoFocus
              ...
              <div className="space-y-2">
                ...
                <div className="text-xs text-gray-500 mt-3 text-center px-4">
                  ...
                  <br />
                  необходимо внести SKU аналога с заполненными Характеристиками
                  и Описанием.
                  <br />
                  Правильно подобранный аналог поможет сделать качественное
                  описание вашей карточки
                </div>
              </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onFormSubmit)}>
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs text-gray-500 mt-3 text-center px-4">
                ...
                Чтобы получить больше данных о вашем товаре,
                <br />
                необходимо внести SKU аналога с заполненными Характеристиками и
                Описанием.
                <br />
                Правильно подобранный аналог поможет сделать качественное
                описание вашей карточки
