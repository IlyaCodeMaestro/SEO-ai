      ...
      <div className="bg-white rounded-xl p-4 shadow-around mb-4">
        <div className="flex">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Update the mobile SKU display with copy icon
            Replace the line with the SKU in the mobile version:
            <p className="text-xs text-blue-600 mt-1">{item.sku}</p>

            With: */}
            <div className="flex items-center mt-1">
              <p className="text-xs text-blue-600">{item.sku}</p>
              <button
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl p-4 w-full sm:w-auto sm:max-w-[550px] sm:ml-0 md:ml-28 shadow-md mb-6 flex flex-col sm:flex-row items-center">
      ...
      <div className="flex-1 overflow-hidden text-center sm:text-left">
        ...
        <div className="flex items-center justify-center sm:justify-start">
          <p className="text-xs text-blue-600 dark:text-gray-400">{item.sku}</p>
          <button
            onClick={() => copyToClipboard(item.sku)}
