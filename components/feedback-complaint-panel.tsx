...
export function FeedbackComplaintPanel({ onClose }: FeedbackComplaintPanelProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="px-4 py-3">
        <div className="bg-[#4C6FFF] text-white rounded-full py-3 text-center font-medium">Пожаловаться</div>
      </div>

      {/* Содержимое */}
      <div className="flex-1 p-6 flex flex-col items-center justify-center">
        <p className="text-gray-500 mb-8 text-center">
          Если у вас возникли проблемы с нашим сервисом или вы хотите оставить жалобу, пожалуйста, напишите нам в
          Телеграм.
        </p>
